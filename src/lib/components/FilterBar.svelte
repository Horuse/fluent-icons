...
<div
	class="flex flex-wrap items-center gap-x-6 gap-y-2 border-b border-slate-200 bg-white px-4 py-2"
>
	<div class="flex items-center gap-1">
		<span class="mr-2 text-[11px] uppercase tracking-wide text-slate-500">style</span>
	...
	<div class="flex items-center gap-1">
		<span class="mr-2 text-[11px] uppercase tracking-wide text-slate-500">size</span>
	...
	<label class="ml-auto flex items-center gap-2">
		<span class="text-[11px] uppercase tracking-wide text-slate-500">columns</span>
		<input
			type="range"
			min="3"
			max="20"
		...
		/>
		<span class="w-6 text-right font-mono text-xs tabular-nums text-slate-700">{columns}</span>
	</label>
</div>